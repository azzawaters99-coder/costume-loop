...
const genres=[
  {n:'Ballet',d:'Tutus, leotards & classical pieces',e:'🩰'},
  {n:'Contemporary',d:'Lyrical, modern & expressive',e:'🌊'},
  {n:'Jazz & Tap',d:'Sequins, top hats & showstoppers',e:'🎩'},
  {n:'Cultural & Character',d:'Traditional, folk & themed outfits',e:'🌏'},
  {n:'Acrobatics',d:'Unitards, bodysuits & stretch fits',e:'🤸'},
  {n:'Hip Hop',d:'Streetwear, caps & urban vibes',e:'🎤'},
