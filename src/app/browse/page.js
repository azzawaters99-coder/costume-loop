...
{listing.images && listing.images.length > 0 ? (
                            <img src={listing.images[0]} alt={listing.title} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                                      ...
                                                      <span className="text-5xl">👗</span>
                                                                            ...
                                                                            <div className="p-4">
                                                    {listing.featured && <span style={{background:'#c49a2a',color:'white',fontSize:11,fontWeight:700,padding:'2px 8px',borderRadius:4,marginBottom:4,display:'inline-block'}}>⭐ Featured</span>}
