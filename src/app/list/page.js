    ...
    <div style={{maxWidth:600,margin:"0 auto",padding:"40px 24px"}}>
      ...
      {step===0&&(
        <div style={{display:"flex",flexDirection:"column",gap:20}}>
          <div>
            <label style={{display:"block",fontWeight:600,fontSize:14,marginBottom:8}}>Listing type</label>
      ...
      <div style={{display:"flex",justifyContent:"space-between",marginTop:36}}>
        ...
        {step<STEPS.length-1
          ...
          :<button onClick={()=>setDone(true)} style={{padding:"12px 28px",borderRadius:10,border:"none",background:"#e8a838",color:"#4a0e2e",fontSize:15,fontWeight:700,cursor:"pointer"}}>Publish Listing 🎉</button>
        }
      </div>
    </div>
  );
